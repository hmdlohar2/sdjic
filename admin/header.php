...
<html lang="en">
  <head>
    ...
    <title>Admin-SDJIC-Alumni System</title>
    ...
    <link rel="stylesheet" href="plugins/jquery.dataTables.min.css" media="screen">
  ...
  <body>
    ...
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">SDJIC Admin Panel</a>
